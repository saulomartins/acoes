...
const styles = StyleSheet.create({
  ...
  body: { flex: 1 }, bodyMobile: { paddingBottom: 92 }, attentionBanner: { marginHorizontal: 14, marginTop: 12, padding: 14, borderRadius: 16, backgroundColor: '#fff4db', borderWidth: 1, borderColor: '#f1d28b', flexDirection: 'row', alignItems: 'center', gap: 10, flexWrap: 'wrap' }, attentionTitle: { color: '#7a4a00', fontSize: 15, fontWeight: '900' }, attentionText: { color: '#8d6517', fontSize: 13, marginTop: 3 }, attentionAction: { minHeight: 34, paddingHorizontal: 12, borderRadius: 17, backgroundColor: '#fff', borderWidth: 1, borderColor: '#e6bf68', alignItems: 'center', justifyContent: 'center' }, attentionActionText: { color: '#7a4a00', fontSize: 13, fontWeight: '900' }, mobileNavShell: { position: 'absolute', left: 0, right: 0, bottom: 0, paddingHorizontal: 6, paddingBottom: 6, paddingTop: 5, backgroundColor: '#fff', borderTopWidth:1,borderTopColor:colors.border,shadowColor:'#101a2e',shadowOffset:{width:0,height:-4},shadowOpacity:.08,shadowRadius:12,elevation:10 }, mobileNav: { gap: 2, paddingHorizontal: 2 }, mobileItem: { minWidth: 74, maxWidth: 92, minHeight: 70, borderRadius: 14, alignItems: 'center', justifyContent: 'center', gap: 3, paddingHorizontal: 6, paddingVertical: 7, backgroundColor: '#fff' }, mobileItemActive: { backgroundColor: colors.softBlue }, mobileIconWrap: { position: 'relative', alignItems: 'center', justifyContent: 'center', minWidth: 34, minHeight: 28 }, mobileIcon: { color: '#667085', fontSize: 23, fontWeight: '800' }, mobileBadge: { position: 'absolute', top: -6, right: -10, minWidth: 22, height: 22, paddingHorizontal: 5, borderRadius: 11, overflow: 'hidden', textAlign: 'center', lineHeight: 22, color: '#fff', backgroundColor: colors.red, fontSize: 12, fontWeight: '900' }, mobileText: { color: '#667085', fontSize: 11, fontWeight: '800', textAlign: 'center' }, mobileActive: { color: colors.primary, fontWeight: '900' },
