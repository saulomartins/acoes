        ...
        <View style={[styles.shell, desktop && styles.shellDesktop]}>
          ...
          <View style={[styles.loginArea, desktop && styles.loginAreaDesktop]}>
            <View style={[styles.loginCard, desktop && styles.loginCardDesktop]}>
              ...
              <TextInput placeholder="Digite seu usuário" value={username} onChangeText={setUsername} style={styles.input} autoCapitalize="none" placeholderTextColor="#99a3b5" />
...
const styles = StyleSheet.create({
  ...
  input: { alignSelf: 'stretch', minWidth: 0, minHeight: 52, borderRadius: layout.controlRadius, borderWidth: 1, borderColor: '#dbe1e7', backgroundColor: '#fff', paddingHorizontal: 13, marginBottom: 15, color: colors.ink, fontSize: 16 }, errorBox: { backgroundColor: '#fff0f0', borderRadius: 8, padding: 10, marginBottom: 12 }, error: { color: colors.red, fontSize: 14, fontWeight: '700' },
