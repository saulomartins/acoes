    ...
    <View style={styles.shell}>
      ...
      <View style={[styles.main, desktop && styles.mainDesktop]}>
        ...
        <ScrollView contentContainerStyle={[styles.content, !desktop && styles.contentMobile]}>
          ...
          <View style={[styles.moduleGrid, desktop ? styles.moduleGridDesktop : styles.moduleGridMobile]}>
            {visibleModules.map((item) => (
              <Pressable key={item.title} disabled={!item.route} onPress={() => open(item.route)} style={({ pressed }) => [styles.moduleCard, !desktop && styles.moduleCardMobile, pressed && item.route && styles.pressed, !item.route && styles.disabled]}>
...
const styles = StyleSheet.create({
  ...
  sectionHead: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 13 }, sectionTitle: { color: '#25374b', fontSize: 18, fontWeight: '900' }, sectionSubtitle: { color: '#8b97a3', fontSize: 14, marginTop: 4 }, moduleGrid: { gap: 12 }, moduleGridDesktop: { flexDirection: 'row', flexWrap: 'wrap' }, moduleGridMobile:{flexDirection:'row',flexWrap:'wrap',gap:10}, moduleCard: { minHeight: 112, flexBasis: '31%', flexGrow: 1, flexDirection: 'row', alignItems: 'flex-start', gap: 13, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: layout.radius, padding: 16, ...shadow },moduleCardMobile:{flexBasis:'47%',minHeight:138,flexDirection:'column',padding:14}, moduleIcon: { width: 38, height: 38, borderRadius: 10, alignItems: 'center', justifyContent: 'center' }, moduleSymbol: { fontSize: 20, fontWeight: '800' }, moduleTitleRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 8 }, moduleTitle: { color: colors.ink, fontSize: 17, fontWeight: '900' }, moduleDescription: { color: colors.muted, fontSize: 14, lineHeight: 19, marginTop: 7 }, arrow: { color: colors.primary, fontSize: 19 }, planned: { color: colors.muted, fontSize: 11, fontWeight: '900' }, pressed: { opacity: .88, transform: [{ scale: .995 }] }, disabled: { opacity: .65 },
  ...
  mobileNav: { position: 'absolute', left: 0, right: 0, bottom: 0, minHeight: 80, backgroundColor: colors.surface, borderTopWidth: 1, borderTopColor: colors.border, flexDirection: 'row', paddingHorizontal: 5, paddingVertical: 6,shadowColor:colors.navy,shadowOffset:{width:0,height:-4},shadowOpacity:.08,shadowRadius:12,elevation:10 }, mobileNavItem: { flex: 1, minHeight: 66, borderRadius:14,alignItems: 'center', justifyContent: 'center', gap: 3, paddingHorizontal: 3 }, mobileNavIcon: { color: '#667085', fontSize: 24, fontWeight: '800' }, mobileNavIconActive: { color: colors.primary, fontSize: 24, fontWeight: '900' }, mobileNavText: { color: '#667085', fontSize: 11, fontWeight: '800', textAlign: 'center' }, mobileNavTextActive: { color: colors.primary, fontSize: 11, fontWeight: '900', textAlign: 'center' },
});
